                ...
                <div className='col '>
                    ...
                    <ul className='col2'>
                        ...
                        <li>
                            ...
                            liaison for all inter-departmental and
                            customer-facing projects.
                        </li>
                        <li>Tested React components using Jest.</li>
                        <li>
                            Consulted for startups and refactored code to
                            implement latest technologies for optimisation and
                            general web presentation, while also ensuring
